...
export default function AppLyVendor({ data }) {
  ...
  return (
    <>
      <HeadSeo title="Đăng ký bán hàng" />
      <div>
        <Breadcrumb previousLink="/" previousValue="Đăng ký" currentValue="Đăng ký bán hàng" />
      </div>
      {/* about section start */}
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="banner-section">
                <img src="/assets/images/vendor-apply.png" className="img-fluid blur-up lazyload" />
              </div>
            </div>
